    ...
    fun setupObjectDetector() {
        ...
        val modelName =
            when (currentModel) {
                ...
                MODEL_STRAYANIMAL -> "Stray_Animal.tflite"
                else -> "Stray_Animal.tflite"
            }
...
//            status_detect.text = "Object in sight."
